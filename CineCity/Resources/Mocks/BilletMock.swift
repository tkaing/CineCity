...
class BilletMock: BilletCall {
    ...
    var ticket1 = Billet(id: 1, time: "18:30", date: Date(), film: Film(id: 1, title: "Star Wars: The Force Awakens", releaseDate: Date()), user: User(id: 1, email: "", password: ""))
    
    var ticket2 = Billet(id: 2, time: "20:00", date: Date(), film: Film(id: 1, title: "2001: A Space Odessey", releaseDate: Date()), user: User(id: 1, email: "", password: ""))
